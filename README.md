...
A minimalist, high-performance **React + TypeScript + Tailwind CSS** assessment application and exam simulator for the **AWS re/Start GHACC71** curriculum and **AWS Certified Cloud Practitioner (CLF-C02)** standard.
