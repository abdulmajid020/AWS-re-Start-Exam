...
export const SupportModal: React.FC<SupportModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-xs animate-fade-in">
      <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden p-6 space-y-5">
        {/* Header */}
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-display font-bold text-slate-900">Support This Project</h3>
              <p className="text-xs text-slate-500">Help keep this AWS prep platform free & open-source</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-2.5">
          ...
          <a
            ...
            className="flex items-center justify-between p-3.5 rounded-xl bg-[#FFDD00]/15 hover:bg-[#FFDD00]/25 border border-[#FFDD00]/60 text-slate-900 text-xs font-semibold transition-all group"
          >
            <div className="flex items-center gap-2.5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 text-xs font-semibold transition-all group"
          >
            <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={handleShare}
            className="w-full flex items-center justify-between p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 text-xs font-semibold transition-all"
          >
            <div className="flex items-center gap-2.5">
