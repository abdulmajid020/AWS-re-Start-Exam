      ...
      <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden p-6">
        <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-display font-bold text-slate-900">Keyboard Shortcuts</h3>
              <p className="text-xs text-slate-500">Navigate quickly without a mouse</p>
            </div>
          </div>
          <button
          ...
          {shortcuts.map((sc, idx) => (
            ...
            >
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-mono px-1.5 py-0.5 rounded bg-white text-slate-600 border border-slate-200">
                  {sc.tag}
                </span>
                <span className="text-xs text-slate-700">{sc.desc}</span>
              </div>
              <kbd className="inline-flex items-center px-2 py-0.5 text-xs font-mono font-semibold bg-white text-slate-900 border border-slate-200 rounded shadow-xs">
                {sc.key}
              </kbd>
            </div>
          ))}
        ...
        <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
          <span className="flex items-center gap-1">
            ...
            Press <kbd className="px-1 bg-slate-100 rounded text-slate-700 border border-slate-200">?</kbd> anytime
          </span>
          <button
            onClick={() => setShortcutsModalOpen(false)}
